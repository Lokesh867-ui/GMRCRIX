    ...
    .forEach(button => {
      ...
      button.onclick = async () => {
        ...
        if (!confirm(
          ...
          'Teams used in match history cannot be deleted.'
        )) return;
...
async function loadMatches() {
  ...
  $('matchList').innerHTML =
    matches.map(match => {
      ...
      /* DELETE OPTION FOR COMPLETED AND CANCELLED MATCHES */
  ...
  /* ===============================
     DELETE COMPLETED/CANCELLED MATCH
  ================================ */
  ...
  document
    ...
    .forEach(button => {
      ...
      button.onclick = async () => {
        ...
        const matchName = button.dataset.name;

        const confirmed = confirm(
          `Delete "${matchName}" permanently?\n\n` +
          'This will permanently remove the match and its related match data.\n\n' +
